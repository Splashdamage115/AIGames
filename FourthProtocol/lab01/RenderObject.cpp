...
RenderObject::RenderObject() : m_window{ sf::VideoMode{ sf::Vector2u{static_cast<unsigned int>(1920u), static_cast<unsigned int>(1080u)}, 32U}, "Fourth Protocol"/*, sf::State::Fullscreen*/}
{
}
