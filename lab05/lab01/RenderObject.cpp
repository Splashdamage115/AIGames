...
RenderObject::RenderObject() : m_window{ sf::VideoMode{ sf::Vector2u{static_cast<unsigned int>(TILE_SIZE * TILE_WIDTH + 1), static_cast<unsigned int>(TILE_SIZE * TILE_WIDTH + 1)}, 32U}, "AI Games"/*, sf::State::Fullscreen*/}
{
}
